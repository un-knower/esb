...
public class HelloWorldProxy implements com.ywx.HelloWorld {
  private String _endpoint = null;
  private com.ywx.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new com.ywx.imp.HellowWorldImpLocator()).getHellowWorldImpPort();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public com.ywx.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
